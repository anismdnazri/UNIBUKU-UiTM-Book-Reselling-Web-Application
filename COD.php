...
?>
    ...
    <br><br>
      <center><img src="images/courier.gif" alt="Delivery" style="width:550px;height:450px;"></center>
    <br>

<h2 class="text-center"> Thank you for Ordering at UniBuku ! The ordering process is now complete.</h2>
...
<h3 class="text-center"><a href="orderstatus.php"<span style="color: blue;">View Order Status Here!</span> </h3>
